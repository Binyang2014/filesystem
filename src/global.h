...
#define RPC_CLIENT_DEBUG DEBUG_N
#define MPI_COMMUNICATION_DEBUG DEBUG_N
#define VFS_RW_DEBUG DEBUG_N
#define DATASERVER_COMM_DEBUG DEBUG_N
#define THREAD_POOL_DEBUG DEBUG_N
#define DATASERVER_BUFF_DEBUG DEBUG_N
#define MAP_DEBUG DEBUG_N
#define MACHINE_ROLE_DEBUG DEBUG_Y
#define MACHINE_ROLE_FETCHER_DEBUG DEBUG_Y
#define DATA_MASTER_DEBUG DEBUG_Y
#define ZSERVER_DEBUG DEBUG_N
#define ZCLIENT_DEBUG DEBUG_N
